...
class CourseFields(object):
    ...
    level_of_education = String(help="Education level required", default="none", scope=Scope.settings)
    is_private = Boolean(help="Set to not show course in public site", default=False, scope=Scope.settings)
                      ...
                      default=[
                          {"short_description": "Getting Started With Studio",
                           "items": [{"short_description": "Add Course Team Members",
                                      ...
                                      {"short_description": "Add Syllabus",
                                      "long_description": "Define sylabus for the course.",
                                      "is_checked": False,
                                      "action_url": "Syllabus",
                                      "action_text": "Create Syllabus",
                                      "action_external": False},
